                ...
                Row(
                  children: [
                    ...
                    linearGradient :  LinearGradient(begin: Alignment.topLeft, 
                                ...
                                colors: [appEngine.myColors['myGreen1']! , appEngine.myColors['myGreen2']!, appEngine.myColors['myGreen3']! ],),
                    center: Text("${percentdate.toStringAsFixed(2)} %", style:TextStyle(fontFamily: appEngine.myFontfamilies["st"], fontSize: appEngine.myFontSize["moreless"],  fontWeight: FontWeight.bold, color: appEngine.myColors["myBlack"])),

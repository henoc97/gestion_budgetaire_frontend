                ...
                Row(
                  children: [
                    ...
                    linearGradient :  LinearGradient(begin: Alignment.topLeft, 
                                ...
                                colors: [appEngine.myColors['myGreen1']! , appEngine.myColors['myGreen2']!, appEngine.myColors['myGreen3']! ],),
                    center: Text((percentdate>=0 &&  percentdate<1)?
                    "${(percentdate * 100).toStringAsFixed(1)} %" : percentdate>1?"100.0%" : "0.0%", style:TextStyle(fontFamily: appEngine.myFontfamilies["st"], fontSize: appEngine.myFontSize["moreless"],  fontWeight: FontWeight.bold, color: appEngine.myColors["myBlack"])),
